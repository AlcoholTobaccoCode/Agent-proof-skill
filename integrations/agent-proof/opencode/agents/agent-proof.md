...
When using the generated integration folder directly, supporting scripts live under `../support/agent-proof/scripts/`. If you install only this agent file, keep the original `agent-proof` skill folder available and run its Node CLI from there.
