...
Install this file as a Copilot custom agent/rule file, and keep the generated `support/agent-proof/scripts/` folder available for deterministic ledger and report commands.
