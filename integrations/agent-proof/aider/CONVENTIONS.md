...
This CONVENTIONS.md entry gives Aider the workflow. Keep the generated `support/agent-proof/scripts/` folder or original skill folder available for the Node/Python checker.
